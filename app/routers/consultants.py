...
from app.services.consultant_service import get_consultant_profile, get_consultant_profile_by_id, update_consultant_profile, get_all_consultants, get_top_rated_consultants
...
@router.get('/top-rated', response_model=list[ConsultantResponse])
...
async def get_the_consultant_profile_by_id(consultant_id: str, db: db_dependency, user: user_dependency):
