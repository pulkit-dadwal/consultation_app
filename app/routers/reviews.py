...
async def create_review_endpoint(review_data: ReviewCreate, db: db_dependency, user: user_dependency):
...
async def get_consultant_reviews_endpoint(consultant_id: str, db: db_dependency):
    """Get reviews for a consultant by their user ID."""
